...
export function LeadCardOverlay({ lead }: LeadCardOverlayProps) {
  return (
    <div className="rounded-xl border border-[#FF6500]/40 bg-[#162d47]/85 backdrop-blur-[8px] p-4 shadow-[0_20px_60px_rgba(0,0,0,0.6)] scale-[1.03] rotate-1 cursor-grabbing w-64">
